...
| `zarasnb1.teszt.js` | A „Meccs utáni pontigazítás" panel (NB1): üres vagy hiányzó adatnál rejtve marad, alapból a legutolsó ilyen fordulót mutatja, szakvezető szerint csoportosít, soronként a konkrét játékos nevével és klubjával, a régi/új érték és az előjeles különbség is látszik (csökkenés és növekedés külön színnel), a játékos neve a profilt, a szakvezetőé a keretet nyitja, és lapozni lehet. |
