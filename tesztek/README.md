...
| `valtozasnaplo.teszt.js` | A változásnapló két szűrője, és hogy a liga **címkeként** működik: a mindkét ligát érintő bejegyzés NB1-re és PL-re szűrve is előjön. A teszt maga állítja elő ezt a bejegyzést, mert a valós adatban ma nincs ilyen. Ellenőrzi a lábléc-linket mindhárom oldalon, és hogy a naplón nincs. |
