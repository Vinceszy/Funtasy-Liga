...
| `zarasnb1.teszt.js` | A „Meccs utáni pontigazítás" panel (NB1): üres vagy hiányzó adatnál rejtve marad, alapból a legutolsó ilyen fordulót mutatja, a régi/új érték és az előjeles különbség is látszik (csökkenés és növekedés külön színnel), és lapozni lehet. |
