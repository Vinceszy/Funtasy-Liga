...
| fájl | mit ellenőriz |
|---|---|
| `cikkertekeles.teszt.js` | Az írás értékelése a cikksáv alján. Azt méri, ami a funkció célja: nem a pontszámot, hanem az **indokot**. Rögzíti, hogy a sáv csak a kinyitott cikkben van ott; hogy a hármas-négyes egyetlen koppintással, kérdés nélkül megy el; hogy az egyes-kettes **helyben** nyit indok-panelt, és a cikk szövege pixelre a helyén marad (nem takarjuk el, amiről véleményt kérünk); hogy a gyorsválasztó és a szabad szöveg is kimegy; hogy a kiút elküldi a pontot, de **indok nélkül** — amit a néző beírt, azt nem írjuk mellé; hogy a kattintás nem csukja be a cikket; és hogy sikertelen küldésnél nem vész el, amit beírtak. |
| `ertekeles.teszt.js` | A Worker értékelés-tárolója (`/ertekeles`), hamis KV-vel — a Workert innen nem lehet elérni. Rögzíti, hogy a pont, a gyorsválasztók és az indok együtt tárolódnak; hogy ugyanaz az eszköz **felülír, nem halmoz**, más eszköz viszont külön sort kap; hogy a tartományon kívüli pont, az ismeretlen cikk-azonosító és a rossz eszközazonosító 400-at kap és **nem ír**; hogy a túl hosszú indok és a túl sok ok le van vágva; és hogy KV-kötés nélkül a Worker megmondja, hogy nem ment el, nem hazudik nyugtát. |
| `cikkertekeles.teszt.js` | Az írás értékelése a cikksáv alján. Azt méri, ami a funkció célja: nem a pontszámot, hanem az **indokot**. Rögzíti, hogy a sáv csak a kinyitott cikkben van ott; hogy a hármas-négyes egyetlen koppintással, kérdés nélkül megy el; hogy az egyes-kettes **helyben** nyit indok-panelt, és a cikk szövege pixelre a helyén marad (nem takarjuk el, amiről véleményt kérünk); hogy a gyorsválasztó és a szabad szöveg is kimegy; hogy a kiút elküldi a pontot, de **indok nélkül** — amit a néző beírt, azt nem írjuk mellé; hogy a kattintás nem csukja be a cikket; és hogy sikertelen küldésnél nem vész el, amit beírtak. |
| `ertekeles.teszt.js` | A Worker értékelés-tárolója (`/ertekeles`), hamis KV-vel — a Workert innen nem lehet elérni. Rögzíti, hogy a pont, a gyorsválasztók és az indok együtt tárolódnak; hogy ugyanaz az eszköz **felülír, nem halmoz**, más eszköz viszont külön sort kap; hogy a tartományon kívüli pont, az ismeretlen cikk-azonosító és a rossz eszközazonosító 400-at kap és **nem ír**; hogy a túl hosszú indok és a túl sok ok le van vágva; és hogy KV-kötés nélkül a Worker megmondja, hogy nem ment el, nem hazudik nyugtát. |
