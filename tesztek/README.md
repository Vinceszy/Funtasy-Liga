...
| `zarasnb1.teszt.js` | A „Zárási változások" panel (NB1): üres vagy hiányzó adatnál rejtve marad, a legördülőben minden lejátszott forduló szerepel (ahol nem volt változás, ott ez van kiírva), alapból a legutolsó változást hozó fordulót mutatja, szakvezető szerint csoportosít, soronként a konkrét játékos nevével és klubjával, a régi/új érték és az előjeles különbség is látszik (csökkenés és növekedés külön színnel), a játékos neve a profilt, a szakvezetőé a keretet nyitja, az ismeretlen játékos sora pedig csak a változás mértékét mutatja, és nem kattintható. |
