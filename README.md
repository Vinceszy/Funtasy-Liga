...
| — | **Az írások értékelése.** A kinyitott cikk alján egytől négyig lehet pontozni. A két felső fokozat egyetlen koppintás — aki elégedett, ne dolgozzon érte. A két alsó **indokot kér**: helyben nyílik egy panel hét gyorsválasztóval és szabad szöveggel, mellette halkabban a kiút („Kötekszem, de indokolni már nem fogok”), ami elmegy, de indok nélkül. A panel a sávon **belül** nyílik, nem új rétegben: épp arról kérünk véleményt, ami alatta áll, azt nem szabad eltakarni. Az értékelés a Workerhez megy (`POST /ertekeles`), és a KV-ben `ert/<cikk>/<eszköz>` kulcson áll — egy eszköz egy írást egyszer értékel, az átértékelés a sajátját írja felül. Visszaolvasni: `GET /ertekelesek`. |
