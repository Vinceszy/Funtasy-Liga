...
- Összesítő oldal a két liga (NB1 + PL) közös követésére — a résztvevők összekötése
  (`FunTasy.SZEMELYEK` a közös rétegben és a közös monogramok) már megvan
