...
| `nemzethy/index.html` | A **Nemzethy Sport** — *Heti Funtasy Magazin*: egy helyen az összes beharangozó és összefoglaló, ligánként, fordulónként visszafelé, teljes szöveggel. A meccs adatlapján a sáv arra válaszol, mi történt AZON a meccsen; ide az jön, aki egyben olvasná végig. **Ugyanaz a kapu**: le nem zárt forduló összefoglalója itt sem látszik — a válogatást a `FunTasy.articleList` végzi, hogy a két nézet ne csúszhasson el abban, mit szabad mutatni. Minden írás alatt ott az értékelő sáv, és egy „Másolom” gomb, ami a rövid változatot meg a cikkre mutató hivatkozást teszi a vágólapra. |
