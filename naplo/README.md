...
| `kele-hang-meres.py` | az utánzott hang forrása: a szerző saját futballos szövegei | a rovat egy létező publicista hangját imitálja, azt pedig olvasni kell, nem találgatni; a szöveg csak a futás naplójába kerül, a repóba nem — amit megtartunk belőle, az a `kele-janek.md`-be írt szabály |
